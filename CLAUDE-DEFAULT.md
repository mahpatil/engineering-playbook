...
version-controlled, repeatable code artifacts
4. **Observability** - Implement distributed tracing, structured logging, and metrics for complete system visibility and rapid issue resolution
5. **Zero Trust Security** - Assume the environment is compromised; authenticate, authorize, and encrypt all flows across all layers
...
8. **Reliability** - Ensure data consistency, fault tolerance, backup and recovery mechanisms to meet SLO/SLA requirements.
...
11. **Infrastructure as Code** - Treat all infrastructure, configuration, and deployments as 
...
- Terraform code for setting up common resources on GCP (but not for application deployment and config)
- GitHub actions for deployment of applications and configuration to GCP 

### Environment Strategy
- Assume two environments Non production and production, both deployed across separate GCP Projects
- 
...
| GitHub actions  | Build and Deploy pipelines   | Row2C3   |
| Code quality and security  | Sonar Scanner  | Row2C3   |
| Secret Management  | GitHub Secrets & GCP   | Row2C3   |
| Infrastructure as Code | Terraform | All infrastructure provisioning to be done via Terraform  |
| IDE | VS Code   |   |
| Artifact management | GCP Artifact Registry   |   |
| Unit testing | Junit (Java),    |   |
| Integration testing | Junit (Java), Jest(JS)   |   |
